...
#main
PYTHONPATH=src python bin/run_patchcore.py --gpu 0  --seed 0 --save_patchcore_model --save_segmentation_images --log_group 182_166_extroi_ps1_white_mask --log_project MVTecAD_Results results \
patch_core -b wideresnet50 -le layer2 -le layer3 --faiss_on_gpu --pretrain_embed_dimension 1024  --target_embed_dimension 1024 --anomaly_scorer_num_nn 1 --patchsize 3 sampler -p 0.1 approx_greedy_coreset dataset --resize 182 --imagesize 182 "${dataset_flags[@]}" mvtec $datapath


#terminal
# PYTHONPATH=src python bin/run_patchcore.py --gpu 0 --seed 0 --save_patchcore_model --log_group IM224_WR50_L2-3_P01_D1024-1024_PS-3_AN-1_S0 --log_project MVTecAD_Results results \
# > patch_core -b wideresnet50 -le layer2 -le layer3 --faiss_on_gpu --pretrain_embed_dimension 1024  --target_embed_dimension 1024 --anomaly_scorer_num_nn 1 --patchsize 3 sampler -p 0.1 approx_greedy_coreset dataset --resize 256 --imagesize 224 -d bottle mvtec /home/genie/patchcore-inspection/mvtec
...
# PYTHONPATH=src python bin/run_patchcore.py --gpu 0 --seed 3 --save_patchcore_model --log_group IM224_Ensemble_L2-3_P001_D1024-384_PS-3_AN-1_S3 --log_online --log_project MVTecAD_Results results \
...
# PYTHONPATH=src python bin/run_patchcore.py --gpu 0 --seed 40 --save_patchcore_model --save_segmentation_images --log_group IM320_Ensemble_L2-3_P001_D1024-384_PS-3_AN-1_S40 --log_project MVTecAD_Results results \
# patch_core -b resnext101 -b densenet201   -le 0.layer2 -le 0.layer2 -le 1.features.denseblock2 -le 1.features.denseblock2  --faiss_on_gpu --pretrain_embed_dimension 1024  --target_embed_dimension 700 --anomaly_scorer_num_nn 1 --patchsize 3 sampler -p 0.1 approx_greedy_coreset dataset --resize 800 --imagesize 800 "${dataset_flags[@]}" mvtec $datapath
